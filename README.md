...
2. [Flujo de la conversión](https://github.com/proyectoTeresIA/TermiGraph_esp/edit/main/README.md#flujo-de-la-conversi%C3%B3n)
3. [Interfaz](https://github.com/proyectoTeresIA/TermiGraph_esp/edit/main/README.md#interfaz)
...
2. **Terminologías TBX-Basic:** terminologías en formato TBX-Basic (_.tbx_) con el estilo DCT. Este conversor a sido desarrollado tomando como base los recursos de [UZEI]()
